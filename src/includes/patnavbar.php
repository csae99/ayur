<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light pt-5  sidebar collapse position-fixed">
    <div class="z-index-n1 bg-light sticky pt-2">
        <ul class="list-unstyled ps-0">
            ...
            <li class="mb-1">
                <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse"
                    data-bs-target="#chatbot-collapse" aria-expanded="true">
                    Chatbot
                </button>
                <div class="collapse " id="chatbot-collapse">
                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        <li><a href="ayur.php" class="link-dark rounded">Acharya Charak</a></li>
                    </ul>
                </div>
            </li>
            <li class="mb-1">
                ...
                <div class="collapse" id="orders-collapse">
                    ...
                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        <li><a href="../ayurmed/index.php" class="link-dark rounded">
                                Buy Medicines</a></li>
                    </ul>
                </div>
            </li>
