            ...
            <form action="products.php" method="POST">
                ...
                <div class="input-group mb-3 form-group">
                    ...
                    <select name="cat" class="form-select" id="inputGroupSelect01">
                        ...
                        <option value="medicine">Herbal Supplements</option>
                        <option value="self-care">Beauty and Skincare</option>
                        <option value="medicine">Digestive Health</option>
                        <option value="medicine">Joint and Muscle Support</option>
                        <option value="self-care">Stress Management</option>
                        <option value="medicine">Hair Care Solutions</option>
                    </select>
                </div>
                <div class="form-group">
