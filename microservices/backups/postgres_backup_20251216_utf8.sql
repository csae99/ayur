...
\restrict JaT8km7imywqbvTYirmZP3tjNKTPaPnDYahPOdI3ptzrEx8hnfBkXeUmsty6k1u
...
--
-- Name: availabilities; Type: TABLE; Schema: public; Owner: user
--
...
ALTER TABLE public.availabilities OWNER TO "user";

--
-- Name: availabilities_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--
...
ALTER TABLE public.availabilities_id_seq OWNER TO "user";

--
-- Name: availabilities_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: user
--
...
--
-- Name: wishlists; Type: TABLE; Schema: public; Owner: user
--
...
ALTER TABLE public.wishlists OWNER TO "user";

--
-- Name: wishlists_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--
...
ALTER TABLE public.wishlists_id_seq OWNER TO "user";

--
-- Name: wishlists_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: user
--
...
--
-- Name: availabilities id; Type: DEFAULT; Schema: public; Owner: user
--
...
--
-- Name: wishlists id; Type: DEFAULT; Schema: public; Owner: user
--
...
5	1	1	2025-12-15	10:00:00	pending	Initial consultation via Ayur Website	2025-12-14 13:15:58.605+00
6	1	1	2025-12-15	11:00:00	pending	Initial consultation via Ayur Website	2025-12-14 13:33:31.932+00
2	1	1	2025-12-15	10:30:00	Pending	Initial consultation via Ayur Website	2025-12-14 11:34:56.471+00
4	1	3	2025-12-16	10:30:00	Cancelled	Initial consultation via Ayur Website	2025-12-14 11:40:55.422+00
\.


--
-- Data for Name: availabilities; Type: TABLE DATA; Schema: public; Owner: user
--

COPY public.availabilities (id, practitioner_id, day_of_week, start_time, end_time, is_available, created_at) FROM stdin;
2	1	Monday	09:00:00	17:00:00	t	2025-12-14 13:15:21.129
3	1	Thursday	09:00:00	17:00:00	t	2025-12-14 13:15:21.129
\.
...
14	3	11	1	2025-12-10 18:32:31.115+00
15	3	19	1	2025-12-10 18:52:24.148+00
\.
...
24	2	1	1	2025-12-12	1	\N	\N	\N	\N	2025-12-17	\N	\N	0	\N
\.
...
6	Dr. Meera	Reddy	dr_meera	$2b$10$a91TulEO3DBZSjeGYDR5W.I1aHvEOqukm.TBpFTRZTRRDqZBvWPIy	meera@ayurveda.com	9876543213	Reddy Ayurvedic Clinic	Hyderabad, Telangana	\N	Ayurvedic Practitioner	Focus on skin and hair care treatments	1234567893	\N	\N	\N	\N	f	t	practitioner	2025-11-23 06:27:31.14763
...
--
-- Data for Name: wishlists; Type: TABLE DATA; Schema: public; Owner: user
--
...
--
-- Name: availabilities_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user
--
...
SELECT pg_catalog.setval('public.cart_items_id_seq', 47, true);
...
--
-- Name: wishlists_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user
--
...
--
-- Name: availabilities availabilities_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: carts carts_user_id_key29; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: carts carts_user_id_key30; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: carts carts_user_id_key31; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: carts carts_user_id_key32; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: carts carts_user_id_key33; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: carts carts_user_id_key34; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: carts carts_user_id_key35; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: carts carts_user_id_key36; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: carts carts_user_id_key37; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: carts carts_user_id_key38; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: carts carts_user_id_key39; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: coupons coupons_code_key12; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: coupons coupons_code_key13; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: coupons coupons_code_key14; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: coupons coupons_code_key15; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: coupons coupons_code_key16; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: coupons coupons_code_key17; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: coupons coupons_code_key18; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: coupons coupons_code_key19; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: coupons coupons_code_key20; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: coupons coupons_code_key21; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: coupons coupons_code_key22; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: wishlists wishlists_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: wishlists wishlists_user_id_item_id_key; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: wishlists_user_id_item_id; Type: INDEX; Schema: public; Owner: user
--
...
--
-- Name: availabilities availabilities_practitioner_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: reviews reviews_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--
...
\unrestrict JaT8km7imywqbvTYirmZP3tjNKTPaPnDYahPOdI3ptzrEx8hnfBkXeUmsty6k1u
